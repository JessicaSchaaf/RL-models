...
etaEstim <- apply(etaEst2,2,mean)
betaEstim <- apply(betaEst2,2,mean)
...
piEst <- samples2$BUGSoutput$sims.list$pi
...
piGroupMeanEst <- samples2$BUGSoutput$sims.list$piGroupMean
piGroupPrecisionEst <- samples2$BUGSoutput$sims.list$piGroupPrecision
strategyEst <- samples2$BUGSoutput$sims.list$strategy
...
piGroupMeanEstim <- mean(piGroupMeanEst)
piGroupPrecisionEstim <- mean(piGroupPrecisionEst)
...
#mean(piTrue-piEstim)  # Compute mean difference between true and estimated Strategy Probability
#cor(piTrue,piEstim)  # Compute corrrelation between true and estimated Strategy Probability
#etaGroupMeanTrue-etaGroupMeanEstim  # Compute difference between true and estimated group-mean LR
#etaGroupPrecisionTrue-etaGroupPrecisionEstim  # Compute difference between true and estimated group-precision LR
#betaGroupMeanTrue-betaGroupMeanEstim  # Compute difference between true and estimated group-mean Decisiveness
#betaGroupPrecisionTrue-betaGroupPrecisionEstim  # Compute difference between true and estimated group-precision Decisiveness
#piGroupMeanTrue-piGroupMeanEstim  # Compute difference between true and estimated group-mean Strategy Probability
#piGroupPrecisionTrue-piGroupPrecisionEstim  # Compute difference between true and estimated group-precision Strategy Probability
#length(which(Z!=strategyEstim))
...
#rm(samples2,data2,myinits2,parameters2,time,nStim,nRep,nPart,etaEst2,betaEst2,piEst,etaGroupMeanEst2,etaGroupPrecisionEst2,betaGroupMeanEst2,betaGroupPrecisionEst2,piGroupMeanEst,piGroupPrecisionEst,strategyEst,etaEstim2,betaEstim2,piEstim,etaGroupMeanEstim2,etaGroupPrecisionEstim2,betaGroupMeanEstim2,betaGroupPrecisionEstim2,piGroupMeanEstim,piGroupPrecisionEstim,strategyEstim)
